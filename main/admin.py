...
from .models import AdvUser, Bb, Token, AdditionalImage, Comment
...
class TokenAdmin(admin.ModelAdmin):
    list_display = (
    "token_name", "purchase_amount", "token_volume", "start_price", "actual_price", "total_actual_price",
    "token_profit", "order_at")
    list_display_links = ("token_name", "purchase_amount")
    search_fields = (
    "token_name", "purchase_amount", "token_volume", "start_price", "actual_price", "total_actual_price",
    "token_profit", "order_at")
