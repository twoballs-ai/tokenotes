# Generated by Django 3.2.8 on 2021-10-30 18:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_amount', models.DecimalField(decimal_places=2, max_digits=11, verbose_name='Количество usd потраченных на покупку')),
                ('token_volume', models.DecimalField(decimal_places=9, max_digits=24, verbose_name='Количество токенов')),
                ('actual_price', models.DecimalField(decimal_places=10, max_digits=25, verbose_name='Текущая цена за токен')),
                ('order_at', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='Опубликовано')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Добавить дополнительный комментарий')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Автор объявления')),
            ],
            options={
                'verbose_name': 'Монета',
