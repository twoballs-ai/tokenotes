...
from .views import index, other_page, BBLoginView, profile, token_profile, BBLogoutView, \
...
urlpatterns = [
    ...
    path('accounts/profile/change/<int:pk>/', profile_token_change,
         name='profile_token_change'),
    path('accounts/profile/delete/<int:pk>/', profile_token_delete,
         name='profile_token_delete'),
    path('accounts/profile/add/', profile_bb_add, name='profile_bb_add'),
    path('accounts/profile/tokenadd/', profile_token_add, name='profile_token_add'),
    path('accounts/profile/<int:pk>/', profile_token_detail,
                                       name='profile_token_detail'),
    # path('accounts/profile/<int:pk>/', profile_bb_detail,
    #                                    name='profile_bb_detail'),
    path('accounts/profile/', token_profile, name='profile'),
